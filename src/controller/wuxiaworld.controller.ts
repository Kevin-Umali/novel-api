...
import { BaseNovelResponse, NovelRouteInterface, NovelChapterResponse, NovelQueryWithRequiredLink, NovelQueryWithRequiredSearch } from "../schema/novel.schema";
...
async function getNovelDetails(
  ...
  try {
    ...
    await puppeteerPage.waitForSelector(".wp-manga-chapter");
